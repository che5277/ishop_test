...
import tableshop.ilinkedtech.com.fragments.actfragments.ActPayDetailFragment;
import tableshop.ilinkedtech.com.utils.StringUtils;


public class PayDetailActivity
        extends BaseActionBarActivity
{
    private ActPayDetailFragment mActPayDetailFragment;
    ...
    public void initView() {
        ...
        mTvToolbarTitle.setText(getString(R.string.支付订单));
    }

    @Override
    protected IShopBaseFragment getShowFragment() {
        mActPayDetailFragment = ActPayDetailFragment.newInstance();
