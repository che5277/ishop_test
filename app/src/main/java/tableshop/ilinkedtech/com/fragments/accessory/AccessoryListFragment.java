...
public class AccessoryListFragment
        extends RecyclerListFragment
{
    ...
    public static AccessoryListFragment newInstance() {
        AccessoryListFragment fragment = new AccessoryListFragment();
    ...
    public void refreshDatas() {
        ...
        mListRequestBean.category="accessory";
