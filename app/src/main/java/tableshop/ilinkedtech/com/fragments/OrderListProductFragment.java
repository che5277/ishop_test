...
import tableshop.ilinkedtech.com.adapters.OrderListProductAdapter;
...
public class OrderListProductFragment
        extends RecyclerListFragment
{

    public static OrderListProductFragment newInstance() {
        OrderListProductFragment fragment = new OrderListProductFragment();
    ...
    protected BaseRecyclerAdapter setRecycleAdapter() {
        ...
        OrderListProductAdapter orderListAdapter = new OrderListProductAdapter(mArrayList, getActivity());
        orderListAdapter.viewType=OrderListAdapter.VIEW_TYPE_PRODUCT_ITEM;
