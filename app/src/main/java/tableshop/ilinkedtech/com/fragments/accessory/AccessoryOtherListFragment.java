...
public class AccessoryOtherListFragment
        extends RecyclerListFragment
{

    private static final String TAG = "AccessoryListFragment";
    ...
    public static AccessoryOtherListFragment newInstance() {
        AccessoryOtherListFragment fragment = new AccessoryOtherListFragment();
    ...
    public void refreshDatas() {
        ...
        mListRequestBean.category="other";
