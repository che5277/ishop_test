 ...
 *  @文件名:   DownLoadProgressBar
 *  @创建者:   Wilson
 *  @创建时间:  2017/11/29 10:50
 *  @描述：    添加圆角支持。
 */
        ...
        implements Runnable
{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) ta.getDimension(R.styleable.DownLoadProgressBar_textSize, 22);
            ...
            radius = (int) ta.getDimension(R.styleable.DownLoadProgressBar_radius, 10);
            borderWidth = (int) ta.getDimension(R.styleable.DownLoadProgressBar_borderWidth, 2);
        } finally {
            ta.recycle();
        }
    }
