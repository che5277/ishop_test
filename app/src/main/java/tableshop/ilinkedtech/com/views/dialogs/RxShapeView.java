        ...
        extends View
{
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(0xaa72d572);//R.color.triangle
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(0x00000000);
        mTriangleColor = 0xaa72d572;//R.color.triangle
        mCircleColor = 0xaa738ffe;//R.color.circle
        mRectColor = 0xaa72d572;//R.color.triangle
    }
