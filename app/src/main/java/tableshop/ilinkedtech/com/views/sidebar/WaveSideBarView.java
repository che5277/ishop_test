...
//        mLetters = Arrays.asList(strings);
        mLetters = Arrays.asList(context.getResources().getStringArray(R.array.waveSideBarLetters));

        mTextColor = Color.parseColor("#5094E3");
        mWaveColor = Color.parseColor("#5094E3");//#be2580D5
        mTextColorChoose = context.getResources().getColor(android.R.color.white);
//        mTextColorChoose = Color.parseColor("#5094E3");
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.text_size_13);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.large_textSize_sidebar);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.slide_bar_padding);//20dp
        if (attrs != null) {
            ...
            mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.padding_20));
...
//        final int newChoose = (int) (Math.abs(y-(mPadding/2)) / mHeight * mLetters.size());
