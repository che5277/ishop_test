        ...
        implements View.OnClickListener
{
    ...
    RelativeLayout    mRlHomeNormal;
    @BindView(R.id.home_layout)
    RelativeLayout    mHomeLayout;
    @BindView(R.id.iv_car_selected)
    ImageView         mIvCarSelected;
    ...
    @BindView(R.id.iv_accessory_selected)
    ImageView         mIvAccessorySelected;
    ...
    public int getLayoutViewId() {
        return R.layout.base_bottom_activity_back;
    }
...
//            checkTokenWithFindMenberId();
    ...
    public void initEvent() {
        ...
        mIvLogo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Intent intent = new Intent(BottomActivity.this, BackendSettingsActivity.class);
                startActivity(intent);
                UIUtils.activityAnimInt(BottomActivity.this);
                return false;
            }
        });
    ...
    public void refreshBottomView(int position) {
        if (mIndex == -1) {
            ...
            mRlHomeNormal.setVisibility(View.VISIBLE);
        ...
        switch (position) {
            case FragmentFactory.FRAGMENT_HOME:
                mRlHomeNormal.setVisibility(View.GONE);
                mHomeSelectedLayout.setVisibility(View.VISIBLE);
                doSeletedAnimate(mIvHomeSelected);
                break;
            case FragmentFactory.FRAGMENT_CHOOSE_CAR:
                mRlCarNormal.setVisibility(View.GONE);
                mCarSelectedLayout.setVisibility(View.VISIBLE);
                doSeletedAnimate(mIvCarSelected);
                break;
            case FragmentFactory.FRAGMENT_ACCESSORY://2
                mRlAccessoryNormal.setVisibility(View.GONE);
                mAccessorySeletedLayout.setVisibility(View.VISIBLE);
                doSeletedAnimate(mIvAccessorySelected);
                break;
            case FragmentFactory.FRAGMENT_MY://3
                mRlMyNormal.setVisibility(View.GONE);
                mMySelectedLayout.setVisibility(View.VISIBLE);
                doSeletedAnimate(mIvMySelected);
                break;
        }
    ...
    private final float scaleBegin = 0.7f;

    private void doSeletedAnimate(ImageView ivSeleted) {
        ivSeleted.setScaleX(scaleBegin);
        ivSeleted.setScaleY(scaleBegin);
        ivSeleted.animate()
                 .scaleX(1.0f)
                 .scaleY(1.0f)
    ...
    private void doNormalAnimate(View ivSeleted) {
        ivSeleted.setScaleX(scaleBegin * 2);
        ivSeleted.setScaleY(scaleBegin * 2);
        ivSeleted.animate()
                 .scaleX(1.0f)
                 .scaleY(1.0f)
                 .setDuration(300)
